function [reward,done] = get_reward_RapidDL(pre_position,now_position,target,field_tree,trees, range)
%% 奖励函数设计，应用与无人机快速强化学习目标路径规划
% trees：导入的树木环境
% field_tree：导入的场地环境
...
if norm(now_position - target) < range
